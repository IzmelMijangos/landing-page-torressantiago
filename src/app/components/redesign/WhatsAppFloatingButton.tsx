// src/app/components/redesign/WhatsAppFloatingButton.tsx
"use client"
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-2xl transition-all duration-300 flex items-center gap-3 group"
        style={{
      ...
      <AnimatePresence>
        {!isHovered && (
          <motion.div
            ...
            exit={{ opacity: 0, x: 20 }}
            transition={{ delay: 2 }}
            className="fixed bottom-24 right-6 z-40 bg-white rounded-lg shadow-xl p-3 max-w-xs hidden md:block"
          >
